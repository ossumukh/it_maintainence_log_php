...
$sqlQuery = "SELECT dummy,COUNT(*) as total_complaints FROM `view_cmp` WHERE `statuses` not like 'closed' group by dummy;
";
   ...
   <h1 style="text-align: center">IT_LOG</h1>
    ...
    >
      <h2 style="text-align: center">
        Line Graph of Technicians vs their Open Complaints in 
      </h2>
      <div
